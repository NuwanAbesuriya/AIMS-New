    ...
    <div class="container text-center">
      <div class="row justify-content-center">
        ...
        <div class="col-sm-5 mb-4">
          <div class="card bg-dark text-dark">
            <div class="card-body">
              <i class="fas fa-seedling fa-3x text-light"></i>
              <h5 class="card-title text-light">Manage Fertilizer Details</h5>
              <a href="../a/cal.php" class="btn btn-outline-warning btn-xl"><i class="fas fa-arrow-right "></i> Go to the form >></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-sm-5 mb-4">
          <div class="card bg-dark text-dark">
            <div class="card-body">
              ...
              <h5 class="card-title text-light"> New User Registration</h5>
              <a href="../view/registration.php" class="btn btn-outline-warning btn-xl"><i class="fas fa-arrow-right "></i> Go to the form >></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-sm-5 mb-4">
          <div class="card bg-dark text-dark">
            <div class="card-body">
              ...
              <h5 class="card-title text-light"> Manage Lands</h5>
              <a href="../view/chart.php" class="btn btn-outline-warning btn-xl"><i class="fas fa-arrow-right "></i> Go to the form >></a>
            </div>
          </div>
        </div>
        <div class="col-sm-5 mb-4">
